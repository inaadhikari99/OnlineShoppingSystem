...
<html lang="en">
  ...
  <title>Easy clothes shopping</title>
            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>01-4810264</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <address>
                      <p> kathmandu </p>
                      <p><span class="fa fa-phone"></span>+9856748569</p>
                      <p><span class="fa fa-envelope"></span>easyclothes@gmail.com</p>
                    </address>
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Supports <a href=#>Payment With</a></p>
